...
- QUnit page: $ ${color('qunitx https://objectmodel.js.org/test/')} — run where it stands, reported as TAP
...
${color('$ qunitx repl --vim')}                      # …with vim keys at the prompt (or ${color('QUNITX_REPL_VIM=1')})
