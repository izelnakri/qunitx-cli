// GENERATED by scripts/write-vendor-runtime.ts from qunitx@1.2.19 — do not edit; run `make vendor`.
  ...
  "node_modules/qunitx/vendor/qunit.js"(exports, module2) {
    (function() {
      ...
      try {
        ...
        try {
          Object.defineProperty(process, "env", { value: {}, writable: true, configurable: true });
        } catch (_2) {
        }
      }
    })();
    (function() {
      ...
      Test.prototype = {
        ...
        pushFailure: function pushFailure3(message, source) {
      ...
      var ConsoleReporter = /* @__PURE__ */ (function() {
        ...
        return _createClass(ConsoleReporter2, [{
          ...
          key: "onTestStart",
          value: function onTestStart(test3) {
            this.log("testStart", test3);
          }
        }, {
          key: "onTestEnd",
          value: function onTestEnd(test3) {
      ...
      var ProcessingQueue = /* @__PURE__ */ (function() {
        ...
        return _createClass(ProcessingQueue2, [{
          ...
          value: function processTaskQueue(start2) {
            var _this = this;
      ...
      extend2(QUnit2, {
        ...
        onUnhandledRejection: function onUnhandledRejection2(reason) {
      ...
      (function() {
        ...
        window$1.addEventListener("unhandledrejection", function(event) {
          if (!QUnit2.config.ignoreUnhandledRejections) {
...
// node_modules/qunitx/dist/browser/index.js
var import_qunit = __toESM(require_qunit(), 1);
var _QUnit = import_qunit.default;
...
function module(moduleName, runtimeOptionsOrContent, moduleContent) {
  const hasOptions = moduleContent !== void 0;
  const callback = hasOptions ? moduleContent : runtimeOptionsOrContent;
  const options = hasOptions ? runtimeOptionsOrContent : {};
  const { skip: skip2 } = options;
  if (skip2) {
    _QUnit.module.skip(moduleName);
    return;
  }
  _QUnit.module(moduleName, function(qunitHooks) {
    callback.call(this, wrapHooks(qunitHooks), { moduleName, options, context: this });
  });
}
module.skip = function skipModule(moduleName) {
  _QUnit.module.skip(moduleName);
};
module.todo = function todoModule(moduleName) {
  _QUnit.module.todo(moduleName);
};
function test(testName, runtimeOptionsOrContent, testContent) {
  const hasOptions = testContent !== void 0;
  const callback = hasOptions ? testContent : runtimeOptionsOrContent;
  const options = hasOptions ? runtimeOptionsOrContent : {};
  const { skip: skip2, todo: todo2 } = options;
  if (skip2) {
    _QUnit.test.skip(testName);
    return;
  }
  const meta = { testName, options, context: {} };
  const wrappedFn = function(assert2) {
    meta.context = this;
    return callback.call(this, assert2, meta);
  };
  if (todo2) {
    _QUnit.test.todo(testName, wrappedFn);
    return;
  }
  import_qunit.default.test(testName, wrappedFn);
}
test.skip = function skipTest(testName) {
  _QUnit.test.skip(testName);
};
test.todo = function todoTest(testName, testContent) {
  ...
  const meta = { testName, options: {}, context: {} };
  _QUnit.test.todo(testName, function(assert2) {
    meta.context = this;
    return testContent.call(this, assert2, meta);
  });
};
function wrapHooks(qunitHooks) {
  return {
    before(fn) {
      const meta = { context: {} };
      qunitHooks.before(function(assert2) {
        meta.context = this;
        return fn.call(this, assert2, meta);
      });
    },
    beforeEach(fn) {
      const meta = { context: {} };
      qunitHooks.beforeEach(function(assert2) {
        meta.context = this;
        return fn.call(this, assert2, meta);
      });
    },
    afterEach(fn) {
      const meta = { context: {} };
      qunitHooks.afterEach(function(assert2) {
        meta.context = this;
        return fn.call(this, assert2, meta);
      });
    },
    after(fn) {
      const meta = { context: {} };
      qunitHooks.after(function(assert2) {
        meta.context = this;
        return fn.call(this, assert2, meta);
      });
    }
...
var browser_default = import_qunit.default;
export {
  assert,
  begin,
  config,
