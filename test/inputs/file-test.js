...
module('File Input Tests', { concurrency: false }, (_hooks, moduleMetadata) => {
  ...
  test('testing a single passing js file with --debug works', async (assert, testMetadata) => {
    const { stdout } = await shell('node cli.js tmp/test/passing-tests.js --debug', {
      ...moduleMetadata,
      ...testMetadata,
    });
  ...
  test('testing a single failing js file works', async (assert, testMetadata) => {
    try {
      let { stdout } = await shell('node cli.js tmp/test/failing-tests.js', {
        ...moduleMetadata,
        ...testMetadata,
      });
    } catch (cmd) {
  ...
  test('testing a single failing js file with --debug works', async (assert, testMetadata) => {
    try {
      await shell('node cli.js tmp/test/failing-tests.js --debug', {
        ...moduleMetadata,
        ...testMetadata,
      });
    } catch (cmd) {
  ...
  test('testing a single passing ts file works, console output supressed', async (assert, testMetadata) => {
    const { stdout } = await shell('node cli.js tmp/test/passing-tests.ts', {
      ...moduleMetadata,
      ...testMetadata,
    });
  ...
  test('testing a single passing ts file with --debug works', async (assert, testMetadata) => {
    const { stdout } = await shell('node cli.js tmp/test/passing-tests.ts --debug', {
      ...moduleMetadata,
      ...testMetadata,
    });
  ...
  test('testing a single failing ts file with --debug works', async (assert, testMetadata) => {
    try {
      await shell('node cli.js tmp/test/failing-tests.ts --debug', {
        ...moduleMetadata,
        ...testMetadata,
      });
    } catch (cmd) {
