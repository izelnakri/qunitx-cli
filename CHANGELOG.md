...
### Bug Fixes
- Do not hand back a result while the browser is still closing — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`c8095af`](https://github.com/izelnakri/qunitx-cli/commit/c8095afc8600f292f61d95c9110390fe32aecc8c))
- Three things the first real transcript exposed — 2026-08-14 by [@izelnakri](https://github.com/izelnakri) ([`709c783`](https://github.com/izelnakri/qunitx-cli/commit/709c783825e394118851beaca553f6e94f448d99))
- Align the upgrade line's comment column — 2026-08-22 by [@izelnakri](https://github.com/izelnakri) ([`f45d5c7`](https://github.com/izelnakri/qunitx-cli/commit/f45d5c77c61697875cf8505239b94ea65a993c8f))
- The page works in a browser you opened yourself — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`5cbe7c1`](https://github.com/izelnakri/qunitx-cli/commit/5cbe7c180af447e635ce8c00c7a3c62e65335a46))
- Give the editor the terminal, and drop what the terminal answers back — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`410003d`](https://github.com/izelnakri/qunitx-cli/commit/410003d1bdb54416b0dfa30cda6f8eead4797f83))
- Erase the suggestion it replaces, and take the one on screen — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`8300455`](https://github.com/izelnakri/qunitx-cli/commit/830045563778198718bd9252fcc86a54fad09c97))
- Hand stdin back only to a prompt that had it — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`5ed705d`](https://github.com/izelnakri/qunitx-cli/commit/5ed705d4fb3332961953bd420caa9b1c07d66199))
- Stop the history file gluing entries together — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`fe43bfc`](https://github.com/izelnakri/qunitx-cli/commit/fe43bfcd440344b6efeb44b26f39b0015f1b274c))
- Never offer a suggestion the line has no room for — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`7b6acf9`](https://github.com/izelnakri/qunitx-cli/commit/7b6acf9fb6dfee8f08979e64027790e26db98abf))
- Declarations at a breakpoint behave like declarations — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`64969da`](https://github.com/izelnakri/qunitx-cli/commit/64969dafb75a21f223fc11ee750390647c4cdb7f))
- The traversal commands took a count and ignored it — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`ec92a57`](https://github.com/izelnakri/qunitx-cli/commit/ec92a57ea64dcf828c7215509ada564f7fc77023))
- A `:` command keeps the colours it would have in your own shell — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`7c90e6c`](https://github.com/izelnakri/qunitx-cli/commit/7c90e6c0314ade5f52a61d68deffef7ae98cf1b6))
- Saving a file the session has loaded loads it again — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`b316d90`](https://github.com/izelnakri/qunitx-cli/commit/b316d90e781288973139836d15d8b3a7c3f2f8ab))
- A file brought in keeps everything known about what it exports — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`85e114c`](https://github.com/izelnakri/qunitx-cli/commit/85e114c6a0724c2ab3cab6244d5130e82d432ac5))
- .break finds a file whose path Windows spells with backslashes — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`a741989`](https://github.com/izelnakri/qunitx-cli/commit/a74198993a8fe596bcd7a32cc9cd3e0e89730888))
- Offer DevTools only where opening it would work — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`f41900e`](https://github.com/izelnakri/qunitx-cli/commit/f41900ea59ed0439135b83e3ede62d47351deb7c))
- --open says it cannot open a window on macOS, instead of dying — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`22028a5`](https://github.com/izelnakri/qunitx-cli/commit/22028a5e5c8aaeb0b952451fdedc4faaf7f29a14))
- FrameSource carried continue()'s doc comment — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`cf020b1`](https://github.com/izelnakri/qunitx-cli/commit/cf020b12ba69e94425ff68427426b0beb63da4e8))
- The nyan tutorial test read a Windows checkout as an empty file — 2026-09-18 by [@izelnakri](https://github.com/izelnakri) ([`eb29213`](https://github.com/izelnakri/qunitx-cli/commit/eb292139157b78bdce85d85c1a48a93d7d646826))

### Documentation
- A section in the README, a verb in the API reference — 2026-08-14 by [@izelnakri](https://github.com/izelnakri) ([`2f8cb84`](https://github.com/izelnakri/qunitx-cli/commit/2f8cb84dbfead3e5a18498577f5c868a801d510b))
- Name repl in the API roundup — 2026-08-22 by [@izelnakri](https://github.com/izelnakri) ([`8bd49e6`](https://github.com/izelnakri/qunitx-cli/commit/8bd49e6b82d11823e0008c474185c14ef1e1bc09))
- The prompt's completion, scope and breakpoint commands — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`0bbb567`](https://github.com/izelnakri/qunitx-cli/commit/0bbb567f68d8f822c32b46bc9c0aaea8d7392c9f))
- Highlighting, the value preview, and theming — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`d1cb16b`](https://github.com/izelnakri/qunitx-cli/commit/d1cb16bc40c597a877aa64857a6773cb89bc1c64))
- The tree, history and clear commands — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`05adf75`](https://github.com/izelnakri/qunitx-cli/commit/05adf756169dbff52b9a5fbe0a6848a403a23371))
- The session's debugger, its modules, and where to inspect it — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`1b8c7b0`](https://github.com/izelnakri/qunitx-cli/commit/1b8c7b0215fd43fc6e7ee476d21cbd0628f57fb6))
- Document the two overloads deno 2.9.6 started asking about — 2026-08-31 by [@izelnakri](https://github.com/izelnakri) ([`01a86b9`](https://github.com/izelnakri/qunitx-cli/commit/01a86b9c035230ab363f3fce4e1fdcd40f9b5480))
- Say whose vocabulary a constant is in, and what each method is for — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`ae05914`](https://github.com/izelnakri/qunitx-cli/commit/ae05914200fdd0d69e9655e49fb9c9a7975ff5a7))
- The nyan tutorial teaches a helper the example does not have — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`d39f896`](https://github.com/izelnakri/qunitx-cli/commit/d39f896c53b3e12d4c3be9ef66206b2c07cced1c))
- Why the completer lists a directory synchronously — 2026-09-19 by [@izelnakri](https://github.com/izelnakri) ([`e438d0e`](https://github.com/izelnakri/qunitx-cli/commit/e438d0e302d46e47ee538d02891ba787202ccd90))
- A by-hand testing guide, walked before it was written — 2026-09-19 by [@izelnakri](https://github.com/izelnakri) ([`e86e662`](https://github.com/izelnakri/qunitx-cli/commit/e86e6623a92f2617d8d15130e3ecbe656d9a838a))
- Update TODO — 2026-09-20 by [@izelnakri](https://github.com/izelnakri) ([`a8e2880`](https://github.com/izelnakri/qunitx-cli/commit/a8e288049a4655d0fe2dbd615b239119236eee33))

### Features
- Evaluate in the page, not in Node — 2026-08-14 by [@izelnakri](https://github.com/izelnakri) ([`71f0e57`](https://github.com/izelnakri/qunitx-cli/commit/71f0e57dc2562803f1562456436d4fc1f46468b2))
- The terminal, on node:repl with a custom eval — 2026-08-14 by [@izelnakri](https://github.com/izelnakri) ([`03859ed`](https://github.com/izelnakri/qunitx-cli/commit/03859ed5cf307aea3e5c5fa30bdffe42553a0647))
- Repl() joins run, watch and search as a verb — 2026-08-14 by [@izelnakri](https://github.com/izelnakri) ([`56bd6c7`](https://github.com/izelnakri/qunitx-cli/commit/56bd6c7cfc29dde55791adc4327e48484ed4a8d2))
- Repl(preload, options) — the call shape every other verb takes — 2026-08-22 by [@izelnakri](https://github.com/izelnakri) ([`69a7952`](https://github.com/izelnakri/qunitx-cli/commit/69a79528e4dcd10ae402b4de7c7f87849ff235d2))
- .cat and .view print a file without leaving the session — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`bfc93b2`](https://github.com/izelnakri/qunitx-cli/commit/bfc93b27e48b2073c1c14295cf7ee4a6418f90bf))
- Ctrl-K and Ctrl-J walk history — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`ff31058`](https://github.com/izelnakri/qunitx-cli/commit/ff31058e3c11a7d5662c9f5984133ef16a0ef4d8))
- Colour values by type, the way node and deno do — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`f29abfd`](https://github.com/izelnakri/qunitx-cli/commit/f29abfd712807b5896f96f4446327750695023c1))
- `:` runs a shell command without leaving the session — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`8037575`](https://github.com/izelnakri/qunitx-cli/commit/8037575d95e1d693f5ce07b64c969e35104cc8da))
- .vi, .vim and .nvim edit a scratchpad that runs on save — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`3afddb5`](https://github.com/izelnakri/qunitx-cli/commit/3afddb59e016497b36b85e6734831043c40c2949))
- `debugger` stops the page, and you can look around — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`9d97ad1`](https://github.com/izelnakri/qunitx-cli/commit/9d97ad116a733f3cefc21325d1da70ad2aae084f))
- Typeahead suggestions, taken with Ctrl-F — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`9e09539`](https://github.com/izelnakri/qunitx-cli/commit/9e09539b3545ba5a9e0aff27866098d2fbd4163f))
- A TypeScript editor's palette, not Node's — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`58fa0d7`](https://github.com/izelnakri/qunitx-cli/commit/58fa0d7beffb480826543327ff58fa809119b8d8))
- Suggest and complete from what the page actually has — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`9826c63`](https://github.com/izelnakri/qunitx-cli/commit/9826c636c91dc3faa5744a991e7da986f39ed69b))
- .scope and .locals, for the two states a session is in — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`cac787b`](https://github.com/izelnakri/qunitx-cli/commit/cac787b9d37a5c7b6c708a23f2f430e687f5031a))
- A tokenizer and a theme, under nvim's own capture names — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`7d23824`](https://github.com/izelnakri/qunitx-cli/commit/7d2382428dfc814e546b7d803a06f604a3266371))
- Paint the line as it is typed, and say how deep it is — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`d55e4cc`](https://github.com/izelnakri/qunitx-cli/commit/d55e4cc68c0ccae7b7a9699ee5dbd19a56e0b69f))
- .cat completes paths, numbers lines, and says why not — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`d9101d6`](https://github.com/izelnakri/qunitx-cli/commit/d9101d61939775198fd6adc580472af1f954e42a))
- Show what the line comes to, before Enter — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`ed2e78e`](https://github.com/izelnakri/qunitx-cli/commit/ed2e78ec2e9cce1a4c31ac56c3edabef74f04529))
- .tree, and .view showing whatever is there — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`c6b55bc`](https://github.com/izelnakri/qunitx-cli/commit/c6b55bc7371c601b46687226a213bfdd7c99c5c1))
- .clear clears the screen, and keeps the scrollback — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`acef8bb`](https://github.com/izelnakri/qunitx-cli/commit/acef8bb681d4b45cd16cad17cbd922efeaa5f9b6))
- .history, the last of what you entered — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`c6c4e04`](https://github.com/izelnakri/qunitx-cli/commit/c6c4e042d613abb5ce193244ac763ee80352904d))
- Show the source a breakpoint stopped in — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`ebcb515`](https://github.com/izelnakri/qunitx-cli/commit/ebcb515ccf0040de188138182f40c192e318791e))
- .step, .next and .finish move through a breakpoint — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`cdac1f2`](https://github.com/izelnakri/qunitx-cli/commit/cdac1f2d8251adb096f74d9526c6f631a04a9944))
- .backtrace, .frame, .up and .down read the rest of the stack — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`908d80f`](https://github.com/izelnakri/qunitx-cli/commit/908d80f949ab07a445cf648dc1aca5883836614e))
- .back goes back, and .here says where that is — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`bbd9b91`](https://github.com/izelnakri/qunitx-cli/commit/bbd9b9181e4f6fad58dadc20b8c8329ea219f9f9))
- .break stops the page at a line you did not edit — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`31922cb`](https://github.com/izelnakri/qunitx-cli/commit/31922cb906081e805e0391fb238ca09c25da1581))
- End the session when the page it was holding has gone — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`561faac`](https://github.com/izelnakri/qunitx-cli/commit/561faacfd0f6b7550ef29b48dec397e82f0d2a55))
- .imported, .doc, .view, .copy — what a value is without printing it — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`a4f962f`](https://github.com/izelnakri/qunitx-cli/commit/a4f962f9c76d0b73ac1c304c4ad6cec8aab18233))
- Short names, and three small answers — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`34cecd2`](https://github.com/izelnakri/qunitx-cli/commit/34cecd20ac1854e6ba356d63504374863fd8500c))
- .import and .load, a file brought in under a name you can type — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`7e8d6d8`](https://github.com/izelnakri/qunitx-cli/commit/7e8d6d8d4ee3ef21c8d0da28880242018b84351f))
- .ls, the name the hand types for a directory — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`9c8bdf8`](https://github.com/izelnakri/qunitx-cli/commit/9c8bdf87e2442658247b1d84cf6f65cb47967c2b))
- .doc, .view and .open answer for a value that is not a function — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`82e8351`](https://github.com/izelnakri/qunitx-cli/commit/82e8351fce6b2b75960c23e7e7bcfb60cc12497c))
- A preloaded file arrives under a name too, the way an imported one does — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`c47b260`](https://github.com/izelnakri/qunitx-cli/commit/c47b2607c41bc4218320c92ddfd8baf910b5fbe7))
- An `import` statement at the prompt does what it says — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`e871e3e`](https://github.com/izelnakri/qunitx-cli/commit/e871e3ecf4b711567c783edb51090bf49e80dacb))
- .v, and a .view that shows the whole value rather than the summary — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`8b1d280`](https://github.com/izelnakri/qunitx-cli/commit/8b1d280006688162a8190d589438fada6f820606))
- One .open, doing what xdg-open does — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`47b481b`](https://github.com/izelnakri/qunitx-cli/commit/47b481ba1f9538631e5aed25f22dcaf20e39b456))
- .d, for the name the hand types — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`4d5c3dd`](https://github.com/izelnakri/qunitx-cli/commit/4d5c3ddb8c023bf65be1f11951b364f7dcd73b4a))
- --open evaluates in a window you can see — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`3613b96`](https://github.com/izelnakri/qunitx-cli/commit/3613b9647f38571d764b40adda642a6fb8baf2b7))
- `<url>/devtools` opens Chrome's own DevTools on the page you are typing into — 2026-08-26 by [@izelnakri](https://github.com/izelnakri) ([`80176ce`](https://github.com/izelnakri/qunitx-cli/commit/80176ce57333ea417d50fe1bef4c0e65e07150b0))
- TypeScript at the prompt, paid for only when it is used — 2026-09-04 by [@izelnakri](https://github.com/izelnakri) ([`4f0e8b7`](https://github.com/izelnakri/qunitx-cli/commit/4f0e8b7043b2990d565121123ee64377263be62c))
- .type says what a value is, in the language you write types in — 2026-09-04 by [@izelnakri](https://github.com/izelnakri) ([`f9bfd66`](https://github.com/izelnakri/qunitx-cli/commit/f9bfd66f25e35608eb6683685d8c72cf80582697))
- [**breaking**] The address is `<url>/repl`, and the bridge is bridge.ts — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`36ffda7`](https://github.com/izelnakri/qunitx-cli/commit/36ffda7310a0845919f9b59a2edeae50241a7c03))

### Performance
- One pass over a directory, and the invariant that was hiding in it — 2026-09-19 by [@izelnakri](https://github.com/izelnakri) ([`30386cd`](https://github.com/izelnakri/qunitx-cli/commit/30386cd49842eec72ebefebb41b37fa088031e8c))

### Refactoring
- One page-side harness for the REPL and for `qunitx run` — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`52e75f2`](https://github.com/izelnakri/qunitx-cli/commit/52e75f23fcd9806dbbe2d904202cf8d7007fb819))
- One painter, and an API that can name what it returns — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`f642c44`](https://github.com/izelnakri/qunitx-cli/commit/f642c44918b63103fce812713d2985240117a995))
- Split the terminal layer into the rooms it already had — 2026-08-25 by [@izelnakri](https://github.com/izelnakri) ([`ecfa7b1`](https://github.com/izelnakri/qunitx-cli/commit/ecfa7b1046cc6e614ed532ba724b91d63372256b))
- [**breaking**] The session's evaluate() is eval() — 2026-09-12 by [@izelnakri](https://github.com/izelnakri) ([`c7dfd6e`](https://github.com/izelnakri/qunitx-cli/commit/c7dfd6e2bd8040a414476ca8b8593187cccf3e6b))
- One file per prompt command, each a { description, main } — 2026-09-12 by [@izelnakri](https://github.com/izelnakri) ([`9a1251c`](https://github.com/izelnakri/qunitx-cli/commit/9a1251cf7337520d1ee3f7e0484fb1d4b1d1dd94))
- Names that say what they do, and three behaviours that were wrong — 2026-09-15 by [@izelnakri](https://github.com/izelnakri) ([`1c6f008`](https://github.com/izelnakri/qunitx-cli/commit/1c6f0085b204b07bf4ba71a36fe81d2719f3a7f5))
- Name every file and function after what a stranger would call it — 2026-09-16 by [@izelnakri](https://github.com/izelnakri) ([`5695ca0`](https://github.com/izelnakri/qunitx-cli/commit/5695ca0c240deb828675c7f8cd77bc9297bb6d63))
- One typeOf per layer, each named for what it takes — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`02672fe`](https://github.com/izelnakri/qunitx-cli/commit/02672fe619565ebccf788dc5434977d0169c0021))
- The socket relay is a proxy, and says so — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`0089b88`](https://github.com/izelnakri/qunitx-cli/commit/0089b885b1ec7f185bed6e840f8cf08be73ae1f2))
- Session.names() is completions(), and says what it offers — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`2e10bdd`](https://github.com/izelnakri/qunitx-cli/commit/2e10bdd33f94e56e51b2a624ab81deffc74627ee))
- InStyle, and the reason a theme is not `red()` — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`a9ad278`](https://github.com/izelnakri/qunitx-cli/commit/a9ad278a61cdeb3393c1a6bd5b489508c5c40a56))
- One function per colour, wherever the colour is fixed — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`5891322`](https://github.com/izelnakri/qunitx-cli/commit/589132276deeecf1deb5da4c0b7e796b28a1a588))
- A frame command is a function, not a factory that makes one — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`0850915`](https://github.com/izelnakri/qunitx-cli/commit/08509151ea44ad4ac38dce517c308c67e0331ae6))
- A module earns its file by having a second caller — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`0e70339`](https://github.com/izelnakri/qunitx-cli/commit/0e70339186aa3e45660b78bb2791d1f390886f7b))
- The prompt's own four live with the prompt — 2026-09-17 by [@izelnakri](https://github.com/izelnakri) ([`31ad711`](https://github.com/izelnakri/qunitx-cli/commit/31ad7119573ee15e7ccfeb60e663c22613787bf5))
- Three file names that named the wrong thing, and their signatures — 2026-09-18 by [@izelnakri](https://github.com/izelnakri) ([`c08f923`](https://github.com/izelnakri/qunitx-cli/commit/c08f92375ba5b01ab4fba93f1e588a81e4368d35))
- Three modules with one caller, and my count was wrong — 2026-09-18 by [@izelnakri](https://github.com/izelnakri) ([`c3a09f0`](https://github.com/izelnakri/qunitx-cli/commit/c3a09f0ee8c4e118b6b842eebae79b0f12c61345))
- One idea per file, and one fewer command doing another's job — 2026-09-18 by [@izelnakri](https://github.com/izelnakri) ([`7deb614`](https://github.com/izelnakri/qunitx-cli/commit/7deb6144b8af90ad4effa2c4c5ae940e90dc2a7d))
- A caller picks a name, not a word to pass — 2026-09-18 by [@izelnakri](https://github.com/izelnakri) ([`d4c29ef`](https://github.com/izelnakri/qunitx-cli/commit/d4c29efe15602a4d605293134c65925d29961e2d))
- SummarizeValue, and valueDetails beside it — 2026-09-18 by [@izelnakri](https://github.com/izelnakri) ([`407900c`](https://github.com/izelnakri/qunitx-cli/commit/407900c9d0ccc7c8d98de774ee7cad9b6e6a0279))
- PrintValueDetails, as asked — 2026-09-18 by [@izelnakri](https://github.com/izelnakri) ([`67c4ed8`](https://github.com/izelnakri/qunitx-cli/commit/67c4ed8db4595863e9015c9f9ab5389ff8ccd52d))
- Files.ts was three jobs in the wrong layer — 2026-09-18 by [@izelnakri](https://github.com/izelnakri) ([`2e06d2e`](https://github.com/izelnakri/qunitx-cli/commit/2e06d2e4e25b1772b618ab3a67d69c13335b9ab7))
- `as` is a TypeScript operator, not a variable name — 2026-09-18 by [@izelnakri](https://github.com/izelnakri) ([`7605e92`](https://github.com/izelnakri/qunitx-cli/commit/7605e924bc45d14203740175fad1786cd1651ebe))
- A theme hands out painters, so inStyle has nothing left to do — 2026-09-19 by [@izelnakri](https://github.com/izelnakri) ([`00a342e`](https://github.com/izelnakri/qunitx-cli/commit/00a342ef677e66658968877c3cd014899e46fe49))
- FindPath stops reading, and the module says what it is about — 2026-09-19 by [@izelnakri](https://github.com/izelnakri) ([`c49b13b`](https://github.com/izelnakri/qunitx-cli/commit/c49b13b6b7196f5f27856037a0917ee21aaee7ed))
- .clear writes a constant, because clearScreen() cleared nothing — 2026-09-19 by [@izelnakri](https://github.com/izelnakri) ([`c128d7e`](https://github.com/izelnakri/qunitx-cli/commit/c128d7e09ffa284ee5e5bb589897e09e0d184a54))
- The crash boundary is two lines, so it lives at the boundary — 2026-09-19 by [@izelnakri](https://github.com/izelnakri) ([`92b6690`](https://github.com/izelnakri/qunitx-cli/commit/92b6690f1ed8405ff868f6a016b133bc83e56626))
...
- Gate `make release` on main, and push there explicitly — 2026-08-02 by [@izelnakri](https://github.com/izelnakri) ([`6715b98`](https://github.com/izelnakri/qunitx-cli/commit/6715b987fb2c984dcba4840e0cbde7605f2230a7))
